...
curl -k -o "alien4cloud-dist-1.4.0-SNAPSHOT.tar.gz" -O "https://fastconnect.org/maven/service/local/repositories/fastconnect-snapshot/content/alien4cloud/alien4cloud-premium-dist/1.4.0-SNAPSHOT/alien4cloud-premium-dist-1.4.0-20170529.090153-17-dist.tar.gz" || error_exit $? "Failed downloading alien4cloud"
