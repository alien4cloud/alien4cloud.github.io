...
| node_templates | yes | Defines a list of [Node template](#/documentation/1.4.0/devops_guide/tosca_grammar/node_template.html)s that model the components of an application or service’s topology within the Service Template. |
...
- [Node template](#/documentation/1.4.0/devops_guide/tosca_grammar/node_template.html)
...
The group construct is a composition element used to group one or more node templates within a TOSCA Service Template. It is mainly used to apply a [Policy](#/documentation/1.4.0/devops_guide/tosca_grammar/policy.html) onto a group of nodes.
...
- [Policy](#/documentation/1.4.0/devops_guide/tosca_grammar/policy.html)
