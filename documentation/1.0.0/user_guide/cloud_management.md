...
{%info%}
To understand the cloud concept, please refer to [this section](#/documentation/1.0.0/concepts/clouds.html).
{%endinfo%}
...
In order to configure a cloud you must have installed a paas provider plugin first see [plugin management](#/documentation/1.0.0/user_guide/plugin_management.html).
...
{%info%}
More informations for [cloudify 2](#/documentation/1.0.0/cloudify2_driver/install_config.html) or [cloudify 3](#/documentation/1.0.0/cloudify3_driver/install_config.html) can be found on her specific documentation.
{%endinfo%}
...
{%info%}
More informations for the PaaS template of [cloudify 2](#/documentation/1.0.0/cloudify2_driver/install_config.html) or [cloudify 3](#/documentation/1.0.0/cloudify3_driver/install_config.html) can be found on her specific documentation.
{%endinfo%}
