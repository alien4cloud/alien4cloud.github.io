...
{%info%}
To understand the topology concept, please refer to [this section](#/documentation/1.0.0/concepts/topologies.html).
{%endinfo%}
...
From now you can use any template when [creating a new application](#/documentation/1.0.0/user_guide/application/application_management.html).
