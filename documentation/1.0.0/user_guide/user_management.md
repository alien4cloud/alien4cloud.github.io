...
If you wish to integrate with an LDAP directory please go [here](#/documentation/1.0.0/admin/ldap.html).
...
{%info%}
To understand the roles concept, please refer to [this section](#/documentation/1.0.0/concepts/roles.html).
{%endinfo%}
