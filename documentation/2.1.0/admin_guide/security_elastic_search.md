...
Generate certificates for your elasticsearch cluster (see [Certificate Generation](#/documentation/2.1.0/admin_guide/certificates.html)), and download premium distribution of Alien4Cloud
