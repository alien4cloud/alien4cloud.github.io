...
{%info%}
To understand the orchestrator and location concepts, please refer to [this section](#/documentation/2.1.0/concepts/orchestrators_locations.html).
{%endinfo%}
...
In order to configure a set of Orchestrator/locations, you must have installed an orchestrator plugin first see [plugin management](#/documentation/2.1.0/user_guide/plugin_management.html).
...
![Create orchestrator](../../images/2.1.0/user_guide/admin/orchestrators/new_orchestrator.png)

## Orchestrator configuration

To configure an orchestrator, select it in the *orchestrator list* page and go to *configuration* side menu.

![Orchestrator conf](../../images/2.1.0/user_guide/admin/orchestrators/orchestrator_global_configuration.png)
...
![Configure the provider](../../images/2.1.0/user_guide/admin/orchestrators/orchestrator_driver_configuration.png)

{%info%}
More informations for [cloudify 3](#/documentation/2.1.0/orchestrators/cloudify4_driver/index.html) can be found on it specific documentation.
{%endinfo%}
...
![Enable - disable  orchestrator](../../images/2.1.0/user_guide/admin/orchestrators/orchestrator_enable.png)
...
![Create location](../../images/2.1.0/user_guide/admin/orchestrators/new_location.png)
...
![Location resources configuration](../../images/2.1.0/user_guide/admin/orchestrators/location_resources_configuration.png)
...
![Location on demand resources](../../images/2.1.0/user_guide/admin/orchestrators/location_on_demand_resource.png)
...
{%warning%}
At this point, we assume that you know what you are doing when creating custom resources. If not, please make sure you go through our [documentation on this feature](#/documentation/2.1.0/user_guide/tosca_catalog_custom_resources.html). Alien has no way to verify if custom resource templates created in the location are compatible with your orchestrator.
{%endwarning%}

![Location custom on demand resources](../../images/2.1.0/user_guide/admin/orchestrators/location_custom_on_demand_resource.png)
...
To manage the authorizations on location, please refer to [this page](#/documentation/2.1.0/user_guide/location_autorization.html).
