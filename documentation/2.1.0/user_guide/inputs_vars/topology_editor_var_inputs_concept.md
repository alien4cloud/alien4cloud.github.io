...
Now that we've been through the concept, let's see [how to manage variables inputs using Alien4Cloud GUI](#/documentation/2.1.0/user_guide/inputs_vars/topology_editor_manage_vars.html).
