...
{%info%}
The previous picture was taken during a Wordpress deployement, to deploy your own Wordpress, please refer to [this section](#/documentation/2.1.0/getting_started/getting_started.html).
{%endinfo%}
