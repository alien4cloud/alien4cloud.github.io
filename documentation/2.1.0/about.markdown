...
# Status
1.4.2 is our latest version. If you wish to start a POC you can consider the 2.1.0 sprint milestones that will let you leverage the latests developed features.
...
* __1.4.2__ is our most stable version and is the latest version that we support.
* __2.1.0__ is still in development and things can change if you start using it. On the other hand all new features are developed in 2.1.0 so you may get more by choosing to start working with this version. We especially recommend that new POCs or project that will really start after we released the 2.1.0 (check our [roadmap](../../roadmap)).
{%endinfo%}

{%warning%}
<h5>Supported platforms</h5>
To get more informations about the supported platforms, please refer to [this section](#/documentation/2.1.0/admin_guide/supported_platforms.html).
{%endwarning%}
