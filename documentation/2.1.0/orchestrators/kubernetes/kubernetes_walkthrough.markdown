...
Starting from 2.1.0 the way we manage Kubernetes integration has changed and is now independent from the orchestrator. Any orchestrator that can fullfill the prerequisites will now be able to leverage on Kubernetes scheduler.
...
- An alien with:
  ...
  - the following archives imported from GIT:
    - https://github.com/alien4cloud/tosca-normative-types.git branch **2.1.0-SM4**
    - https://github.com/alien4cloud/alien4cloud-extended-types.git branch **2.1.0-SM4** folder **alien-base-types**
    - https://github.com/alien4cloud/docker-tosca-types.git **2.1.0-SM4** folder **docker-types**
