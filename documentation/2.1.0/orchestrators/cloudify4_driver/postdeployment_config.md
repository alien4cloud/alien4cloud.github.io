...
If you are working with the premium cloudify 4 plugin, then you have a feature that allows you to add and execute patches and custom operations on a deployed application. It needs to have a [patches server deploy somewhere](#/documentation/2.1.0/admin_guide/post_deployment_application.html), and to makes some configurations.
