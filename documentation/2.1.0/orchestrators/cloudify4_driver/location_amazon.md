...
When scaling a compute with a reusable volume, A4C will keep trace of the volume ID and zone (more details [here](/#/documentation/2.1.0/orchestrators/cloudify4_driver/index.html)).  
