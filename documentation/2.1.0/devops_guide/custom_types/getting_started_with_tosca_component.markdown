...
{% note %}
More details on the TOSCA file definition [here](#/documentation/2.1.0/devops_guide/tosca_grammar/definitions_file.html)
{% endnote %}
...
* [Upload your CSAR into Alien4Cloud](#/documentation/2.1.0/user_guide/catalog_type_upload.html)
