...
![Location modifiers](../../images/3.1.0/orchestrators/kubernetes/adapter_modifier_configuration.png)
...
![Topology](../../images/3.1.0/orchestrators/kubernetes/apache_simple_container.png)
...
![Deployment outputs](../../images/3.1.0/orchestrators/kubernetes/apache_simple_container_deployment.png)

![Apache index page](../../images/3.1.0/orchestrators/kubernetes/apache_simple_container_service.png)
...
![Deployment modelization](../../images/3.1.0/orchestrators/kubernetes/emptyDir.png)
The emptyDir volume properties appear by clicking on the EmptyDirVolumeSource  node :

![emptyDir properties](../../images/3.1.0/orchestrators/kubernetes/emptyDir_2.png)
...
![Deployment modelization](../../images/3.1.0/orchestrators/kubernetes/Hostpath_1.png)
...
![Volume on the K8S cluster filesytem - properties](../../images/3.1.0/orchestrators/kubernetes/Hostpath_2.png)

![Volume on the K8S cluster filesytem - path](../../images/3.1.0/orchestrators/kubernetes/Hostpath_3.png)
...
![Volume on the container](../../images/3.1.0/orchestrators/kubernetes/Hostpath_4.png)
...
![Deployment modelization](../../images/3.1.0/orchestrators/kubernetes/Secret_1.png)

- The Secret volume properties appear by clicking on the SecretSource node :

![Secret volume properties](../../images/3.1.0/orchestrators/kubernetes/Secret_2.png)

- Properties on container which hosts it

![Secret volume properties](../../images/3.1.0/orchestrators/kubernetes/Secret_3.png)
...
![Volume on the container](../../images/3.1.0/orchestrators/kubernetes/Secret_4.png)

- Topology folder which containers files to be put in secret :

![Volume on the container](../../images/3.1.0/orchestrators/kubernetes/Secret_5.png)

![Volume on the container](../../images/3.1.0/orchestrators/kubernetes/Secret_6.png)
...
![Topology](../../images/3.1.0/orchestrators/kubernetes/apache_configMap_1.png)
...
![Config map properties](../../images/3.1.0/orchestrators/kubernetes/apache_configMap_2.png)
...
![Config map contents](../../images/3.1.0/orchestrators/kubernetes/apache_configMap_3.png)
...
![Config map variables](../../images/3.1.0/orchestrators/kubernetes/apache_configMap_4.png)
...
![Topology](../../images/3.1.0/orchestrators/kubernetes/apache_env_2.png)
...
![Environnement variables specification](../../images/3.1.0/orchestrators/kubernetes/apache_env_1.png)
...
![Deployment outputs debug mode](../../images/3.1.0/orchestrators/kubernetes/apache_simple_container_deployment_debug.png)
