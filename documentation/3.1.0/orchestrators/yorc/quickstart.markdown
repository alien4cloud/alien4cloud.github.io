...
Now we have the Petclinic template ready to use, we can create an application based on it. To do this, go to the ![applications](../../../../images/3.1.0/yorc/application-btn.png){: height="26px" .inline} section. Click on the ![new application](../../../../images/3.1.0/yorc/new-application-btn.png){: height="26px" .inline} button and select the **PetclinicTemplate** in the table at the bottom of the popup.

![Create Application](../../../../images/3.1.0/yorc/new-welcome-app.png)

The application creation should redirect you on the application details page. 

![Welcome Application topology](../../../../images/3.1.0/yorc/welcome-app-topo.png)
...
- And click on ![deploy button](../../../../images/3.1.0/yorc/app-deploy-btn.png){: height="26px" .inline}

![Select a location](../../../../images/3.1.0/yorc/app-location.png)
...
![Application Deployment info](../../../../images/3.1.0/yorc/app-info-deployment.png)
...
![Application runtime view](../../../../images/3.1.0/yorc/app-runtime-view.png)
