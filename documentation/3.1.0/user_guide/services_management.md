...
![service_list](../../images/3.1.0/user_guide/admin/services/service_list.png)
...
![create_external_service](../../images/3.1.0/user_guide/admin/services/create_external_service.png)

After the creation, the service appears on the left hand side list and can be configured.

![service_list_with_external_mongo](../../images/3.1.0/user_guide/admin/services/service_list_with_external_mongo.png)
...
![service_detail](../../images/3.1.0/user_guide/admin/services/service_detail.png)
...
![defining_capabilities_attributes_for_service](../../images/3.1.0/user_guide/service/user_attributes.png)
...
![service_location](../../images/3.1.0/user_guide/service/service_location.png)
...
![service_security](../../images/3.1.0/user_guide/service/service_security.png)
...
![service_consumption](../../images/3.1.0/user_guide/service/service_consumption.png)

On matching screen, your AbstractMongod will be matched to the service that has been defined lately

![service_matching](../../images/3.1.0/user_guide/admin/services/service_matching.png)
...
![service_topology](../../images/3.1.0/user_guide/admin/services/service_topology.png)
...
![service_exposition](../../images/3.1.0/user_guide/admin/services/service_exposition.png)


As an admin, the service exposed will be displayed automatically in the service list *[Administration]* > *Service*

![service_list_with_exposed_mongo](../../images/3.1.0/user_guide/admin/services/service_list_with_exposed_mongo.png)
...
![service_list](../../images/3.1.0/user_guide/service/service_mongodb_relationship.png)
