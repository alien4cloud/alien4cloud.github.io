...
Inputs may be a secret that will be retrieved later at deployment time by clicking on ![Go to admin](../../images/3.1.0/user_guide/topology_editor/secret_property _button.png){: .inline}.

![Deployment inputs](../../images/3.1.0/user_guide/applications/deployment/user_guide_deployment_setup_inputs.png)
...
![Configure your deployment](../../images/3.1.0/user_guide/applications/deployment/user_guide_deployment_setup.png)
...
![Node substitution](../../images/3.1.0/user_guide/applications/deployment/user_guide_deployment_setup_substitution.png)
...
![deploy](../../images/3.1.0/user_guide/applications/deployment/deployment_deploy.png)
...
![credential_modal](../../images/3.1.0/user_guide/applications/deployment/credential_modal.png)
