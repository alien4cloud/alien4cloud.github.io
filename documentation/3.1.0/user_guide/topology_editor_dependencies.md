...
[![Choose dependency when adding a node](../../images/3.1.0/user_guide/topology_editor/dragndrop_dependency.png)](../../images/3.1.0/user_guide/topology_editor/dragndrop_dependency.png)

The same behavior applies when defining relationships between nodes, as shown below.

[![Choose dependency when adding a relationship](../../images/3.1.0/user_guide/topology_editor/relationship_dependency.png)](../../images/3.1.0/user_guide/topology_editor/relationship_dependency.png)
...
[![Manual changing of a dependency version](../../images/3.1.0/user_guide/topology_editor/dependencies_change.png)](../../images/3.1.0/user_guide/topology_editor/dependencies_change.png)
...
[![Transitive dependency conflict between jdk-type and tosca-normative-types](../../images/3.1.0/user_guide/topology_editor/dependency_conflict.png)](../../images/3.1.0/user_guide/topology_editor/dependency_conflict.png)
