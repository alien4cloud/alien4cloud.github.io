...
To find more on locations and how to configure them in Alien 4 Cloud please look at the [Getting started](#/documentation/1.3.0/getting_started/getting_started.html) guide if you don't already have an Alien instance running and at the [cloud setup guide](#/documentation/1.3.0/user_guide/cloud_management.html) in order to learn cloud configuration.
