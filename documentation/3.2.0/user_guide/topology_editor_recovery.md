...
[![topology recovery modal](../../images/3.2.0/user_guide/topology_editor/topology_recovery_modal.png)](../../images/3.2.0/user_guide/topology_editor/topology_recovery_modal.png){:target="_blank"}<br>
