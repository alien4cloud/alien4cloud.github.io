...
![Petclinc url](../../images/3.2.0/user_guide/user_guide_topology_template_runtime.png)
...
![Workflow view](../../images/3.2.0/user_guide/workflow_view.png)

#Execution

You can access to the Execution view by a submenu of the **Execution** view. In this page you can see deployment steps list :

![Execution view](../../images/3.2.0/user_guide/execution_view_1.png)

You can access to the log step by clicking on the log icon.

![Step Execution view](../../images/3.2.0/user_guide/execution_view_2.png)
...
![Custom workflow view](../../images/3.2.0/user_guide/custom_workflow_inputs.png)
