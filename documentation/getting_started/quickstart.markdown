...
* Download and unzip the package [vm-alien4cloud-SM27](https://fastconnect.org/owncloud/public.php?service=files&t=de94bb1a61091c58f5eb860c63a46c5f) (for other version, see on the page footer). As a result, a subdirectory vm-alien4cloud should be created
