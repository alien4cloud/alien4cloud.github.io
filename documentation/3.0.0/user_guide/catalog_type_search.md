...
![Component list](../../images/3.0.0/user_guide/catalog/types/catalog_overview.png)
...
Alien4cloud computes some handy facets for you to filter the search results. In order to display the available filters, just click on the filter button (![Filter button](../../images/3.0.0/user_guide/catalog/types/filter_button.png){: height="22px" .inline}).

Every section can be collapsed. In order to select a filter value, just click on a proposed value.

![Filters](../../images/3.0.0/user_guide/catalog/types/filters.png)

In order to remove a filter, just click on it in the search bar (![Filter button](../../images/3.0.0/user_guide/catalog/types/remove_filter.png){: height="22px" .inline}).
...
[![Component details](../../images/3.0.0/user_guide/catalog/types/component_details.png)](../../images/3.0.0/user_guide/catalog/types/component_details.png)
