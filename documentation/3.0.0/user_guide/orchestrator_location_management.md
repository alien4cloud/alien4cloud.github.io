...
![Create orchestrator](../../images/3.0.0/user_guide/admin/orchestrators/new_orchestrator.png)

## Orchestrator configuration

To configure an orchestrator, select it in the *orchestrator list* page and go to *configuration* side menu.

![Orchestrator conf](../../images/3.0.0/user_guide/admin/orchestrators/orchestrator_global_configuration.png)
...
![Enable - disable  orchestrator](../../images/3.0.0/user_guide/admin/orchestrators/orchestrator_enable.png)
...
![Create location](../../images/3.0.0/user_guide/admin/orchestrators/new_location.png)
...
![Location resources configuration](../../images/3.0.0/user_guide/admin/orchestrators/location_resources_configuration.png)
...
![Location on demand resources](../../images/3.0.0/user_guide/admin/orchestrators/location_on_demand_resource.png)
