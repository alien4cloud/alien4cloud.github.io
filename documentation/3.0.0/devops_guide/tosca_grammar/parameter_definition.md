...
See [function_definition](#/documentation/3.0.0/devops_guide/tosca_grammar/function_definition.html).

{% info %}
For Alien 4 Cloud property definition syntax support you can refer to the [property_definition page](#/documentation/3.0.0/devops_guide/tosca_grammar/property_definition.html).
{% endinfo %}
