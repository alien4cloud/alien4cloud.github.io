...
To be more concret we will use the [Wordpress](#/documentation/1.2.0/getting_started/lamp_stack_wordpress.html) component to install a real CMS.
...
1. Get, checkout, download all components listed in the [main page](#/documentation/1.2.0/getting_started/lamp_stack.html) of this tutorial
2.  [Import components](#/documentation/1.2.0/user_guide/components_management.html)  of the Wordpress topology in **A4C**
3. Configure your cloud plugin [PaaS Provider](#/documentation/1.2.0/orchestrators/cloudify3_driver/index.html)
