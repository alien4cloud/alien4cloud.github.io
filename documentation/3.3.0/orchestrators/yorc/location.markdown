...
To define meta-properties, go to ![administration](../../../../images/3.3.0/yorc/administration-btn.png){: height="26px" .inline} and in the ![orchestrator](../../../../images/3.3.0/yorc/meta-menu-btn.png){: height="26px" .inline} sub-menu.

Then you can create a new meta-property by clicking on ![new meta-property](../../../../images/3.3.0/yorc/new-meta-prop.png){: height="26px" .inline} and providing a name, a description and other information that characterize it.
...
![Meta-properties definition](../../../../images/3.3.0/yorc/meta-properties.png)
...
To create an orchestrator, go to ![administration](../../../../images/3.3.0/yorc/administration-btn.png){: height="26px" .inline}  and in the ![orchestrator](../../../../images/3.3.0/yorc/orchestrator-menu-btn.png){: height="26px" .inline} sub-menu. Create an orchestrator named **Yorc** with the following named plugin:

- Yorc Orchestrator : <version>.

At this moment your orchestrator is created but not enabled. Click on your orchestrator to see the information page, and then click on the configuration menu icon ![orchestrator configuration](../../../../images/3.3.0/yorc/orchestrator-config-btn.png){: height="26px" .inline}.
...
Once your orchestrator is created and enabled, go to the locations page by clicking on ![orchestrator location](../../../../images/3.3.0/yorc/orchestrator-location-btn.png){: height="26px" .inline}

## Configure an OpenStack Location

Create a new location clicking on ![new location](../../../../images/3.3.0/yorc/new-location.png){: height="26px" .inline} and provide a location name. Select **OpenStack** in the infrastructure type drop-down.

The details page of your location should appear.

Go to ![on-demand resources](../../../../images/3.3.0/yorc/on-demand-ressource-tab.png){: height="26px" .inline} and add the following resources:
...
![Network configuration](../../../../images/3.3.0/yorc/orchestrator-loc-conf-net.png)
...
![Compute Node configuration](../../../../images/3.3.0/yorc/orchestrator-loc-conf-compute.png)

## Configure a Slurm Location

Go to the locations page by clicking on ![orchestrator location](../../../../images/3.3.0/yorc/orchestrator-location-btn.png){: height="26px" .inline}

Create a new location clicking on ![new location](../../../../images/3.3.0/yorc/new-location.png){: height="26px" .inline} and provide a location name. Select **Slurm** in the infrastructure type drop-down.

The details page of your location should appear.

Go to ![on-demand resources](../../../../images/3.3.0/yorc/on-demand-ressource-tab.png){: height="26px" .inline} and add the following resource:
...
![Compute Node configuration](../../../../images/3.3.0/yorc/slurm-compute.png)
...
![Compute Node credentials](../../../../images/3.3.0/yorc/slurm-credentials.png)
...
![Compute Node credentials key](../../../../images/3.3.0/yorc/slurm-creds-key.png)
...
Create a new location clicking on ![new location](../../../../images/3.3.0/yorc/new-location.png){: height="26px" .inline} and provide a location name. Select **HostsPool** in the infrastructure type drop-down.
...
![Compute Node configuration](../../../../images/3.3.0/yorc/hosts-pool-compute.png)
...
Create a new location clicking on ![new location](../../../../images/3.3.0/yorc/new-location.png){: height="26px" .inline} and provide a location name. Select **Google Cloud** in the infrastructure type drop-down.
...
![Compute configuration](../../../../images/3.3.0/yorc/google-compute-on-demand.png)
...
![Compute Instance credentials](../../../../images/3.3.0/yorc/google-credentials.png)
...
![Compute Instance credentials key](../../../../images/3.3.0/yorc/google-creds-key.png)
...
![PublicNetwork configuration](../../../../images/3.3.0/yorc/google-public-network.png)
...
![PersistentDisk configuration](../../../../images/3.3.0/yorc/google-disk-on-demand.png)
...
![PrivateNetwork configuration](../../../../images/3.3.0/yorc/google-vpc-on-demand.png)
...
![CustomSubnet configuration](../../../../images/3.3.0/yorc/google-vpc-subnet.png)
...
Create a new location clicking on ![new location](../../../../images/3.3.0/yorc/new-location.png){: height="26px" .inline} and provide a location name. Select **AWS** in the infrastructure type drop-down.
...
![Compute configuration](../../../../images/3.3.0/yorc/aws-compute-on-demand.png)
...
![EBSVolume configuration](../../../../images/3.3.0/yorc/aws-volume-on-demand.png)
...
Select **Yorc** orchestrator and go to the locations page by clicking on ![orchestrator location](../../../../images/3.3.0/yorc/orchestrator-location-btn.png){: height="26px" .inline}.
...
Go to ![on-demand resources](../../../../images/3.3.0/yorc/on-demand-ressource-tab.png){: height="26px" .inline} and search in the **Catalog** resources with type prefix **org.alien4cloud.kubernetes.api.types**. You have to add the following resources:
...
Go to ![topology modifier](../../../../images/3.3.0/yorc/topology-modifier-tab.png){: height="26px" .inline} view to check modifiers are uploaded to your location:
...
![Namespace specification in the location](../../../../images/3.3.0/yorc/location-meta-properties.png)
...
![Namespace specification in the application](../../../../images/3.3.0/yorc/application-meta-properties.png)
