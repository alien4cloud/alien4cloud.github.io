...
After configuring your OpenStack location as described previously click on the ![policies button](../../../../images/3.3.0/yorc/policies-button.png){: height="26px" .inline} button, select **Catalog** and use the search to find the ServerGroupAntiAffinity as below.

![Search serverGroup policy](../../../../images/3.3.0/yorc/search-servergroup-policy.png)
...
![Configure your serverGroup policy](../../../../images/3.3.0/yorc/servergroup-policy-resource.png)
...
Select your application and go to the **Topology Editor**. Click on the ![policies button](../../../../images/3.3.0/yorc/topology-policies-button.png){: height="52px" .inline} button on the vertical blue bar on the right. Click on the **+ Add policies** button, search the abstract policy node **AntiAffinity** (org.alien4cloud.policies.AntiAffinity) from alien-base-types and drag-and-drop it on the policies list of your topology.
...
![Add abstract anti-affinity policy to your topology application](../../../../images/3.3.0/yorc/placement-topology-editor.png)
...
![Policy matching before deploying application](../../../../images/3.3.0/yorc/policy-matching.png)
...
After configuring your OpenStack location as described previously click on the ![policies button](../../../../images/3.3.0/yorc/policies-button.png){: height="26px" .inline} button, select **Catalog** and use the search to find the TCPMonitoring as below.

![Search TCP monitoring policy](../../../../images/3.3.0/yorc/search-tcpmonitoring-policy.png)
...
![Configure your TCP monitoring policy](../../../../images/3.3.0/yorc/tcpmonitoring-policy-resource.png)

### Edit application topology

Select your application and go to the **Topology Editor**. Click on the ![policies button](../../../../images/3.3.0/yorc/topology-policies-button.png){: height="52px" .inline} button on the vertical blue bar on the right. Click on the **+ Add policies** button, search the policy node **TCPMonitoring** (yorc.policies.monitoring.TCPMonitoring) and drag-and-drop it on the policies list of your topology.
...
![Add TCP monitoring policy to your application topology](../../../../images/3.3.0/yorc/tcpmonitoring-topology-editor.png)
...
After configuring your OpenStack location as described previously, click on the ![policies button](../../../../images/3.3.0/yorc/policies-button.png){: height="52px" .inline} button, select **Catalog** and use the search to find the HTTPMonitoring as below.

![Search HTTP monitoring policy](../../../../images/3.3.0/yorc/search-httpmonitoring-policy.png)
...
![Configure your HTTP monitoring policy](../../../../images/3.3.0/yorc/httpmonitoring-policy-resource.png)
...
Click on the ![policies button](../../../../images/3.3.0/yorc/topology-policies-button.png) button on the vertical blue bar on the right.
...
![Configure HTTP Monitoring policy](../../../../images/3.3.0/yorc/configure-http-monitoring-policy.png)
...
![Welcome component in stopped state](../../../../images/3.3.0/yorc/welcome-error.png)
...
![Welcome component in started state](../../../../images/3.3.0/yorc/welcome-ok.png)
...
After configuring your HostsPool location as described previously click on the ![policies button](../../../../images/3.3.0/yorc/policies-button.png){: height="26px" .inline} button, select **Catalog** and use the search to find **policies.hostspool** as below.

![Search hosts pool policies](../../../../images/3.3.0/yorc/search-hostspool-policy.png)
...
![Configure your hosts pool policies](../../../../images/3.3.0/yorc/hostspool-policy-resource.png)
...
Select your application and go to the **Topology Editor**. Click on the ![policies button](../../../../images/3.3.0/yorc/topology-policies-button.png){: height="52px" .inline} button on the vertical blue bar on the right. Click on the **+ Add policies** button, search the abstract policy node **Placement** (tosca.policies.Placement) and drag-and-drop it on the policies list of your topology.
...
![Add placement policy to your application topology](../../../../images/3.3.0/yorc/placement-abstract-topology-editor.png)
...
![Select your policy during policies matching step](../../../../images/3.3.0/yorc/hostspool-policies-matching.png)
