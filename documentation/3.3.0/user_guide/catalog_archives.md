...
![Add pane](../../images/3.3.0/user_guide/catalog/archives/add_pane.png)

{%inittab%}
{% tabcontent Create new archive %}

You can create a new empty archive thanks to the ![New archive](../../images/3.3.0/user_guide/catalog/archives/new_archive_button.png){: height="22px" .inline} button.
...
![Drag and drop upload](../../images/3.3.0/user_guide/catalog/archives/drag_drop_upload.png)
...
![Workspace selection](../../images/3.3.0/user_guide/catalog/archives/workspace_selection.png)
...
Click on ![Git import](../../images/3.3.0/user_guide/catalog/archives/git_import_button.png){: height="22px" .inline} in order to access the git repositories management screen. From this screen users can register git repositories in alien4cloud and trigger import of the git repository content to alien4cloud.

In order to register a new git repository click on ![Git location](../../images/3.3.0/user_guide/catalog/archives/new_git_location_button.png){: height="22px" .inline}. Then fill the information on the modal as specified below.

![New git location modal](../../images/3.3.0/user_guide/catalog/archives/new_git_location_modal.png){: style="width: 600px; margin: 0 auto"}
...
![Trigger an archive from a location](../../images/3.3.0/user_guide/catalog/archives/git_location_list.png)

Click on ![Git location](../../images/3.3.0/user_guide/catalog/archives/git_import_btn.png){: .inline} to trigger the import process. Once completed the import result is displayed with it's state, and eventual errors, warning or info messages.

![Result of an import](../../images/3.3.0/user_guide/catalog/archives/git_import_result.png)
{%endtabcontent%}
{%endinittab%}
...
![Upload an archive with error](../../images/3.3.0/user_guide/catalog/archives/csar-upload-errors.png)
...
![Archive list](../../images/3.3.0/user_guide/catalog/archives/archive_list.png)
...
* a brief overview of the archive content, the following icon ![Archive list](../../images/3.3.0/user_guide/catalog/archives/topology_icon.png){: height="22px" .inline} shows if the archive contains a topology template and the following icon ![Archive list](../../images/3.3.0/user_guide/catalog/archives/type_icon.png){: height="22px" .inline} shows that the archive contains some node types (the number of nodes is indicated).

You can perform the following actions from the list:

* Click on an element of the list to go to the archive detail screen.
* Click on ![Download archive](../../images/3.3.0/user_guide/catalog/archives/download_archive.png){: height="22px" .inline} to download the archive as a zip file.
* You can see the workspace that currently contains the archive, and change it by clicking on the following button ![Archive list](../../images/3.3.0/user_guide/catalog/archives/change_workspace.png){: height="22px" .inline} (text and icon of the button depends on the workspace). If you move an archive to a workspace on which you don't have write access, a promotion request will be created. [More on promotion requests](#/documentation/3.0.0/user_guide/catalog_workspaces.html).
* Click on ![Delete](../../images/3.3.0/user_guide/catalog/archives/delete.png){: height="22px" .inline} to delete an archive
