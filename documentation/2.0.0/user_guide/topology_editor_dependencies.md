...
[![Choose dependency when adding a node](../../images/2.0.0/user_guide/topology_editor/dragndrop_dependency.png)](../../images/2.0.0/user_guide/topology_editor/dragndrop_dependency.png)

The same behavior applies when defining relationships between nodes, as shown below.

[![Choose dependency when adding a relationship](../../images/2.0.0/user_guide/topology_editor/relationship_dependency.png)](../../images/2.0.0/user_guide/topology_editor/relationship_dependency.png)
...
[![Manual changing of a dependency version](../../images/2.0.0/user_guide/topology_editor/dependencies_change.png)](../../images/2.0.0/user_guide/topology_editor/dependencies_change.png)
...
[![Transitive dependency conflict between jdk-type and tosca-normative-types](../../images/2.0.0/user_guide/topology_editor/dependency_conflict.png)](../../images/2.0.0/user_guide/topology_editor/dependency_conflict.png)
