...
If you wish to integrate with an LDAP directory please go [here](#/documentation/2.0.0/admin_guide/ldap.html).
...
If you use the premium version and wish To use SAML please check the documentation [here](#/documentation/2.0.0/admin_guide/saml.html).
{%endinfo%}
...
{%info%}
To understand the roles concept, please refer to [this section](#/documentation/2.0.0/concepts/roles.html).
{%endinfo%}
