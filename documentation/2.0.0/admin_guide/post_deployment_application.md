...
The Alien post-deployment web application is a Spring boot application, that helps managing patches or operations added to a node within a deployment. You MUST deploy it if you plan on providing to the users the ability to perform [post deployment operations](#/documentation/2.0.0/user_guide/application_post_deployment.html) on an application.  
...
## Using ssl
See [security section](#/documentation/2.0.0/admin_guide/security_patch.html).

##ElasticSearch
See [Elastic Search configuration](#/documentation/2.0.0/admin_guide/advanced_configuration.html) section.
