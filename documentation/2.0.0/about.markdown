...
# Status
1.4.2 is our latest version. If you wish to start a POC you can consider the 2.0.0 sprint milestones that will let you leverage the latests developed features.
