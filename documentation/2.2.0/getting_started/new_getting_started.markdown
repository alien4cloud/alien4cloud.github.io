...
* __Browser__: A supported web browser (check versions [here](/#/documentation/2.2.0/admin_guide/supported_platforms.html)).
...
![Login screen](../../images/2.2.0/getting_started/authentication-splash-screen.png)
...
{%note%}
The admin user is granted will all rights on the platform. This getting started will perform all operations using the admin user. Of course if you want to setup an Alien4Cloud for production usage and multi-users and role management you should probably refer to [advanced configurations and installation](#/documentation/2.2.0/admin_guide/advanced_configuration.html) of Alien4Cloud as well as user guide for [user management](#/documentation/2.2.0/user_guide/user_management.html).
{%endnote%}
...
Click on ![Go to admin](../../images/2.2.0/getting_started/components_menu.png){: height="26px" .inline} button in the navigation bar. Then click side bar sub-menu ![Go to git](../../images/2.2.0/getting_started/git_sub_menu.png){: height="26px" .inline}.
Now add a new Git location: ![new-git-location](../../images/2.2.0/getting_started/git_location_new.png){: height="26px" .inline}.
...
![git configuration](../../images/2.2.0/getting_started/git_configuration.png){: style="width: 600px; margin: 0 auto"}

Now, click on ![import button](../../images/2.2.0/getting_started/import.png){: height="26px" .inline} to pull all components from git and upload them into the Alien4Cloud catalog.

Wait for the import success bar to show and continue:

![Import success](../../images/2.2.0/getting_started/import_success.png)
...
{% info %}
Find detailed informations about the Wordpress topology in the [devops guide](#/documentation/2.2.0/devops_guide/lamp_stack_tutorial/lamp_stack_application.html).
{% endinfo %}

# Create a Wordpress application

Now we have the Wordpress template ready to use, we can create an application based on it. To do this, go to ![application menu](../../images/2.2.0/getting_started/applications_menu.png){: height="26px" .inline} section. Click on ![new application btn](../../images/2.2.0/getting_started/new_application.png){: height="26px" .inline}. In the new application modal fill the name with 'wordpress', click on Topology Template button and select the `wordpress-topology` in the **topology template** list.

![New application modal](../../images/2.2.0/getting_started/new_application_modal.png)

Click on _create_ to create the application and be redirected to the application informations page. To see your application topology, click on ![application topology menu](../../images/2.2.0/getting_started/topology_sub_menu.png){: height="26px" .inline}. This will take you to the topology editor.

![Wordpress Topology](../../images/2.2.0/getting_started/topology_editor.png)
...
Click on ![application deployment](../../images/2.2.0/getting_started/application_deployment_menu.png){: height="26px" .inline} to configure your deployment:
...
![Location choice](../../images/2.2.0/getting_started/location_choice.png)
...
So let's go on node matching tab ![Node matching tab](../../images/2.2.0/getting_started/node_matching_tab.png){: height="26px" .inline} and select the wordpress compute node called 'computeWww' in our topology
![Compute Www](../../images/2.2.0/getting_started/matching_computeWww.png){: height="26px" .inline}, then click on the current selected match for the node (well and only choice on this location as currently defined).

![Compute Www matching choice](../../images/2.2.0/getting_started/matching_computeWww_choice.png){: style="width: 600px; margin: 0 auto"}

Let's first expose the port out of the container by changing the exposed_ports property: Click on the edition button for the exposed_ports property ![Exposed ports property](../../images/2.2.0/getting_started/exposed_ports_edit.png){: height="26px" .inline}. In the modal click on the ![Add Exposed port](../../images/2.2.0/getting_started/exposed_ports_add.png){: height="26px" .inline} button to add a new port exposition. Click on the 0 element edit button ![Add Exposed port](../../images/2.2.0/getting_started/exposed_ports_0_edit.png){: height="26px" .inline} and set 80 to the port and tcp to the protocol and close the modal.

![Exposed port configuration](../../images/2.2.0/getting_started/exposed_ports_conf.png){: style="width: 400px; margin: 0 auto"}

Let's now configure the port_mappings ![Exposed ports property](../../images/2.2.0/getting_started/ports_mappings_edit.png){: height="26px" .inline} using the same procedure to configure a port mapping from 80 to, for example 9099

![Exposed port configuration](../../images/2.2.0/getting_started/ports_mappings_conf.png){: style="width: 120px; margin: 0 auto"}

Ok now that the port from the docker container is exposed to the outside world we can deploy our application!

So just go to the deploy tab and click on the ![Deploy](../../images/2.2.0/getting_started/deploy_button.png){: height="26px" .inline} button! Note that this may take a few minutes as we are going to download and install the various components of the topology.

{%info%}
<h5>More on matching and application configuration</h5>
If you have not done it yet, you can get more informations on the [application](#/documentation/2.2.0/concepts/applications.html) concepts in alien4cloud as well as [deployment configuration and matching](#/documentation/2.2.0/concepts/deployment.html) concepts here.
You can also read more on the alien user guide's [application management section](#/documentation/2.2.0/user_guide/application_management.html).
{%endinfo%}

# Check that your application is up and running

On the runtime view, you can have the detailed deployment progress. Click on the side bar sub-menu ![application runtime](../../images/2.2.0/getting_started/runtime.png){: height="26px" .inline},

![Runtime view](../../images/2.2.0/getting_started/runtime_view.png){: style="width: 600px; margin: 0 auto"}
...
![Wordpress home](../../images/2.2.0/getting_started/wordpress_home.png){: style="width: 300px; margin: 0 auto"}
...
{% highlight bash %}
pkill -f 'alien4cloud-ui-2.2.0-SNAPSHOT.war'
{% endhighlight %}
...
Now you can [go further into the getting started](#/documentation/2.2.0/getting_started/going_further_cfy_boot.html) to see more cool stuffs, like how to deploy on Amazon cloud. (Example of a cloudify manager)

You can see more details about Puccini's supported locations and resources [here](#/documentation/2.2.0/orchestrators/puccini/puccini_main_page.html).

For more, take a look on the [user guide](#/documentation/2.2.0/user_guide/user_guide.html).

If you want to understand a bit more about the concepts developed in Alien4cloud, [here you go](#/documentation/2.2.0/concepts/concepts.html), and you might want to check out for the [TOSCA usage guide](#/documentation/2.2.0/getting_started/devops_guide/dev_ops_guide.html) too.
