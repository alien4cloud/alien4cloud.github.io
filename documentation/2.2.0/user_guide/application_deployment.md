...
Inputs may be a secret that will be retrieved later at deployment time by clicking on ![Go to admin](../../images/2.2.0/user_guide/topology_editor/secret_property _button.png){: .inline}.

![Deployment inputs](../../images/2.2.0/user_guide/applications/deployment/user_guide_deployment_setup_inputs.png)
...
![Configure your deployment](../../images/2.2.0/user_guide/applications/deployment/user_guide_deployment_setup.png)
...
![Node substitution](../../images/2.2.0/user_guide/applications/deployment/user_guide_deployment_setup_substitution.png)

# Deploy
This is the last step. If the orchestrator defined some deployment properties, here is the place to fill them up.
You can also decide (if possible) if you want to expose your deployment as a service. ([More about services here...](#/documentation/2.2.0/concepts/services.html))

![deploy](../../images/2.2.0/user_guide/applications/deployment/deployment_deploy.png)
...
You can now follow the deployment progress on the [runtime view](#/documentation/2.2.0/user_guide/application_runtime.html).
...
![credential_modal](../../images/2.2.0/user_guide/applications/deployment/credential_modal.png)
...
Since this feature strongly depends on underlying orchestrator, you should refer to the dedicated documentation portion of the orchestrator you are using to know more about this feature ([for Cloudify orchestrator](#/documentation/2.2.0/orchestrators/cloudify4_driver/deployment_update.html)).
