...
{%note%}
TOSCA Simple profile in YAML provides some pre-defined Node Types, more informations on the various pre-defined node types can be found [here](#/documentation/2.2.0/devops_guide/normative_types/tosca_concepts_types_normative.html).
{%endnote%}
