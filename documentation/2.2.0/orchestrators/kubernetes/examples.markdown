...
- An alien with:
  ...
  - the following archives imported from GIT:
    - https://github.com/alien4cloud/tosca-normative-types.git branch **2.2.0-SM6**
    - https://github.com/alien4cloud/alien4cloud-extended-types.git branch **2.2.0-SM6** folder **alien-base-types**
    - https://github.com/alien4cloud/docker-tosca-types.git **2.2.0-SM6** folder **docker-types**
