...
![location node affinity add](../../../images/2.2.0/user_guide/policies/add_k8s_nodeAffinity_policy.png){: margin: 50}
...
![node affinity matchExpressions](../../../images/2.2.0/user_guide/policies/node_aff_matchExp_edit.png){: margin: 50}
...
![node affinity matchExpressions](../../../images/2.2.0/user_guide/topology_editor/policies/node_aff_matchExp_edit.png){: margin: 50}

Configure the deployment on the kubernetes location. Once the location selected, yu should see logs like this:

![node affinity matchExpressions](../../../images/2.2.0/user_guide/policies/nodeAff_config_ok.png){: margin: 50}
