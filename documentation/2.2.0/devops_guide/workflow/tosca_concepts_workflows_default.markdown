...
[![*Default node's install workflow](../../images/2.2.0/concepts/install_wf_node.png)](../../images/2.2.0/concepts/install_wf_node.png){:target="_blank"}
...
[![*Default relationship's install workflow](../../images/2.2.0/concepts/install_wf_rel.png)](../../images/2.2.0/concepts/install_wf_rel.png){:target="_blank"}
...
[![*Default node's uninstall workflow](../../images/2.2.0/concepts/uninstall_wf_node.png)](../../images/2.2.0/concepts/uninstall_wf_node.png){:target="_blank"}
...
[![*Default relationship's uninstall workflow](../../images/2.2.0/concepts/uninstall_wf_rel.png)](../../images/2.2.0/concepts/uninstall_wf_rel.png){:target="_blank"}
...
[![*Default node's start workflow](../../images/2.2.0/concepts/start_wf_node.png)](../../images/2.2.0/concepts/start_wf_node.png){:target="_blank"}
...
[![*Default relationship's start workflow](../../images/2.2.0/concepts/start_wf_rel.png)](../../images/2.2.0/concepts/start_wf_rel.png){:target="_blank"}
...
[![*Default node's stop workflow](../../images/2.2.0/concepts/stop_wf_node.png)](../../images/2.2.0/concepts/stop_wf_node.png){:target="_blank"}
...
[![*Default relationship's stop workflow](../../images/2.2.0/concepts/stop_wf_rel.png)](../../images/2.2.0/concepts/stop_wf_rel.png){:target="_blank"}
