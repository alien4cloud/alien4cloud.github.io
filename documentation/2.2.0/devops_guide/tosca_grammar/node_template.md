...
| interfaces | no | An optional list of named [interface definitions](#/documentation/2.2.0/devops_guide/tosca_grammar/interface_definition.html) that override those coming from type. |
...
| interfaces | no |  An optional list of named [interface definitions](#/documentation/2.2.0/devops_guide/tosca_grammar/interface_definition.html) that override those coming from relationship type. |
