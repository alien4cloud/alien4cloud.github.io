...
{% warning %}
<h5>Tosca support in ALien 4 Cloud 2.2.0</h5>
...
Alien 4 Cloud2.2.0 is very close to TOSCA 1.0.0 but still has a few differences.
...
This section details the differences between TOSCA Simple Profile and Alien 4 Cloud 2.2.0 dsl:
