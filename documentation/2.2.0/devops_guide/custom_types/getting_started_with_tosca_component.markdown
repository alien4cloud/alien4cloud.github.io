...
{% note %}
More details about CSAR [here](#/documentation/2.2.0/concepts/tosca.html)
{% endnote %}
...
{% note %}
More details on the TOSCA file definition [here](#/documentation/2.2.0/devops_guide/tosca_grammar/definitions_document.html)
{% endnote %}
...
{% note %}
More details about node type definition [here](#/documentation/2.2.0/devops_guide/tosca_grammar/node_type.html)
{% endnote %}
...
{% note %}
More details about the capability definition [here](#/documentation/2.2.0/devops_guide/tosca_grammar/capability_definition.html)
{% endnote %}
...
{% note %}
More details about the relationship type [here](#/documentation/2.2.0/devops_guide/tosca_grammar/relationship_type.html)
{% endnote %}

# Next steps

* Going deeper to write TOSCA components
    * [LAMP Stack Tutorial](#/documentation/2.2.0/devops_guide/lamp_stack_tutorial/lamp_stack.html)
    * [Create your own components](#/documentation/2.2.0/devops_guide/design_tutorial/tutorials.html)
* [Going deeper with TOSCA](#/documentation/2.2.0/devops_guide/tosca_grammar/tosca_grammar.html)
