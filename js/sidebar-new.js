  ...
  sidebarTree["DOCUMENTATION-1.2.0"] = {
    ...
    'collapsed': true
      ...
      var parent = sidebarTree["DOCUMENTATION-1.2.0"];
        ...
        node = null;
        for (var i=0; i<children.length; i++) {
          if(children[i].name === 'postdeploment_ssl_config') {
            node = children[i];
          }
        }
        if(node === null) {
      ...
      node.name = "postdeploment_ssl_config";
      node.title = "Postdeployment SSL configuration";
      node.url = "documentation/1.2.0/orchestrators/cloudify3_driver/postdeployment_ssl_config.html";
      node.weight =  1000;
      node.root = "../../../";
