...
var node, children;
  ...
  sidebarTree["DOCUMENTATION"] = {
    ...
    'collapsed': true
      ...
      node.url = "documentation/user_guide/application/application_management.html";
      node.weight =  400;
      node.root = "../../";
      ...
      var parent = sidebarTree["DOCUMENTATION"];
        ...
        node = null;
        for (var i=0; i<children.length; i++) {
          if(children[i].name === 'application_management_advanced_inputs') {
            node = children[i];
          }
        }
        if(node === null) {
      ...
      node.name = "application_management_advanced_inputs";
      node.title = "Advanced inputs";
      node.url = "documentation/user_guide/application/application_management_advanced_inputs.html";
      node.weight =  410;
      node.root = "../../";
      ...
      node.title = "concat";
      node.url = "documentation/devops_guide/tosca_grammar/concat_definition.html";
      node.weight =  500;
      node.root = "../../../";
      ...
      node.url = "documentation/cloudify2_driver/deployment_properties.html";
      node.weight =  40000;
      node.root = "../../";
      ...
      node.url = "documentation/devops_guide/tosca_grammar/get_operation_output_definition.html";
      node.weight =  400;
      node.root = "../../../";
      ...
      var parent = sidebarTree["DOCUMENTATION"];
        ...
        node = null;
        for (var i=0; i<children.length; i++) {
          if(children[i].name === 'getting_started_prerequisites') {
            node = children[i];
          }
        }
        if(node === null) {
      ...
      node.name = "getting_started_prerequisites";
      node.title = "Prerequisites";
      node.url = "documentation/getting_started/getting_started_prerequisites.html";
      node.weight =  200;
      node.root = "../../";
      ...
      var parent = sidebarTree["DOCUMENTATION"];
        ...
        node = null;
        for (var i=0; i<children.length; i++) {
          if(children[i].name === 'getting_started_start') {
            node = children[i];
          }
        }
        if(node === null) {
      ...
      node.name = "getting_started_start";
      node.title = "Quick Start";
      node.url = "documentation/getting_started/getting_started_start.html";
      node.weight =  300;
      node.root = "../../";
      ...
      node.url = "documentation/cloudify2_driver/operation_outputs.html";
      node.weight =  104;
      node.root = "../../";
      ...
      node.title = "Policy";
      node.url = "documentation/devops_guide/tosca_grammar/policy.html";
      node.weight =  300;
      node.root = "../../../";
      ...
      node.title = "The 30 min Start Guide!";
      node.url = "documentation/getting_started/quickstart.html";
      node.weight =  100;
      node.root = "../";
      ...
      node.url = "documentation/admin/supported_platforms.html";
      node.weight =  200;
      node.root = "../../";
